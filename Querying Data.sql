...
SELECT department_id, Sum(salary) From employees Where department_id=7;
...
SELECT d.Department_name, count(e.employee_id) As Number_of_employees
        ...
        On e.department_id = d.department_id
        Group By e.department_id having count(e.employee_id)<3;


/* Find locations with female employees whose average age is below 30 */


SELECT l.Location, e.gender, avg(e.age) As Average_Age
		From Employees e Join Location l
        On e.location_id = l.location_id
        where gender='F'
        Group By l.location_id having avg(e.age)<30;
...
SELECT l.Location, e.Employee_name 
			From employees e Right Join location l
            ON e.location_id=l.location_id;
            
            
  /* inserting values just to check whether the above querry is correct for the scenario mentioned*/


INSERT into departments(department_id,department_name)
values (14,"Production");
